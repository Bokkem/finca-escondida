...
export const bentoFeatures: BentoFeature[] = [
  { id: "pool", title: "Infinity Pool", description: "A 22-metre infinity pool suspended above the Mediterranean. Swim towards the horizon.", image: "/images/pool.webp", size: "large" },
  { id: "chef", title: "Private Chef", description: "Your personal chef crafts bespoke menus using the finest local produce from across Ibiza.", image: "/images/kitchen.webp", size: "medium" },
  { id: "spa", title: "Wellness Retreat", description: "A private spa with hammam, sauna and massage studio. Your own sanctuary.", image: "/images/spa.webp", size: "medium" },
  { id: "terrace", title: "Al Fresco Dining", description: "Two terraces. One for sunset aperitifs, one for long candlelit dinners beneath the stars.", image: "/images/terrace.webp", size: "small" },
  { id: "cellar", title: "Wine Cellar", description: "A curated selection of over 400 bottles. Your sommelier is one call away.", image: "/images/cellar.webp", size: "small" },
  { id: "location", title: "Ibiza's North", description: "Nestled in the secluded hills of San Carlos. Total privacy, eight minutes from the sea.", image: "/images/exterior.webp", size: "medium" },
];

export const amenities: Amenity[] = [
  { icon: "wifi", title: "High-speed Wi-Fi", description: "High-speed fibre throughout the property" },
  { icon: "car", title: "Chauffeur Service", description: "Airport transfers and day excursions arranged" },
  { icon: "boat", title: "Boat Charter", description: "Private yacht available on request" },
  { icon: "shield", title: "24/7 Security", description: "Discreet round-the-clock security" },
  { icon: "sun", title: "Concierge", description: "Whatever you need, whenever you need it" },
  { icon: "music", title: "Entertainment", description: "Private cinema and whole-property sound system" },
];
